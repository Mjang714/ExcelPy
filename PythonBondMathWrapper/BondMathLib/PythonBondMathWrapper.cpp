...
PYBIND11_MODULE(bondMathLib, m) {
	...
	m.def("computeYield", (double (*) (double, double, double, int)) &getYield, "finds the yield of a bond when given price, coupone rate, time till maturity, and compounding", "years"_a, "couponRate"_a, "bondPrice"_a, "compound"_a);
	m.def("computeYield", (double (*) (double, double, double, std::string)) & getYield, "finds the yield of a bond when given price, coupone rate, time till maturity, and compounding", "years"_a, "couponRate"_a, "bondPrice"_a, "compound"_a);
