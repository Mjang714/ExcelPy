...
double computeYieldHelper(double yield, double bondPrice, std::vector<double> maturitySchedule, std::vector<double> cashflowSchedule) {
    ...
    if(abs(newYield - yield) > 0.00000000001){
        return computeYieldHelper(newYield, bondPrice,maturitySchedule,cashflowSchedule);
    }
